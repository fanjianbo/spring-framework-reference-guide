...
------
### 2.3 应用场景
上一章节中描述的各个模块让Spring在成为N多应用场景中得到应用，从资源受限的嵌入式应用程序到使用Spring事务管理功能和Web集成功能的企业级应用系统，使用Spring都是最佳选择之一。

图2.2 经典的Spring Web应用程序架构
![](https://github.com/fanjianbo/picture/blob/master/res/overview-full.png.pagespeed.ce.sC26wirtWB.png?raw=true)
